...
<div class="ad-image feaimg"><a class="block-fea" href="<?php $this->permalink(); ?>" style="background-image: url('<?php echo stcdnimg($this->fields->img); ?>');"></a><?php if ($this->fields->videourl): ?><div class="entyr-icon ico-p"><i class="icon iconfont icon-icon-test15"></i></div><?php else : ?><div class="entyr-icon"><?php echo ''.imgNums($this->content).'' ; ?></div><?php endif; ?></div>
...
<div class="featured-container">
					...
					<div class="author-infos" data-id="<?php echo geipuid($this->cid); ?>"><?php $email=$this->author->mail; $imgUrl = getGravatar($email);echo '<img src="'.$imgUrl.'" srcset="'.$imgUrl.'" class="avatar avatar-140 photo" height="25" width="25">'; ?> <?php $this->author->screenName(); ?>
...
<article class="post-list contt featured" id="post_<?php $this->cid(); ?>">
       <div class="featured-container">
                    <header class="entry-header featitle">
					 ...
					 <div class="entry-meta fea-meta">
					   <div class="author-infos" data-id="<?php echo geipuid($this->cid); ?>"><?php $email=$this->author->mail; $imgUrl = getGravatar($email);echo '<img src="'.$imgUrl.'" srcset="'.$imgUrl.'" class="avatar avatar-140 photo" height="25" width="25">'; ?>
        ...
        <div class="feaimg fea-21x9">
            <a id="post_a_<?php $this->cid(); ?>" class="feaimg-content scrollLoading" title="<?php $this->title(); ?>" href="<?php if ($this->fields->videourl && ($this->options->ajxplay == '1') && ($this->options->aboutme) ): ?>javascript:;fn_conid(<?php $this->cid(); ?>)<?php else : ?><?php $this->permalink(); ?><?php endif; ?>" data-url="<?php echo stcdnimg($this->fields->bimg); ?>"><i class="mask"></i></a>
			<?php if ($this->fields->videourl): ?><div class="entyr-icon ico-p"><i class="icon iconfont icon-icon-test15"></i></div><?php else : ?><div class="entyr-icon"><?php echo ''.imgNums($this->content).'' ; ?></div><?php endif; ?>
...
<article class="post-list contt blockimg " id="post_<?php $this->cid(); ?>">
                <div class="entry-container"><span class="laid_title_l"></span>
                    ...
                    <a id="post_a_<?php $this->cid(); ?>" class="block-fea scrollLoading" data-url="<?php echo stcdnimg($this->fields->img); ?>" href="<?php if ($this->fields->videourl && ($this->options->ajxplay == '1') && ($this->options->aboutme) ): ?>javascript:;fn_conid(<?php $this->cid(); ?>)<?php else : ?><?php $this->permalink(); ?><?php endif; ?>" title="<?php $this->title(); ?>" ><i class="mask"></i>
                    ...
                    <div class="entry-meta">
                       ...
                       <!--作者卡片-->
                        ...
                        <span class="separator">/</span>
                        <?php Postviews($this); ?> 阅读 <p class="meta-zan"><i class="icon iconfont icon-aixin"></i> <?php zannum($this); ?>赞</p></div> 
