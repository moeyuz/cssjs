...
<div class="part-mor">
  ...
  <div class="section-cont">
    <div class="items">	  
      ...
      <div class="item"><div class="hunter-item"><a href="<?php $relatedPosts->permalink(); ?>" ><div class="hunter-thumb"><i class="thumb " style="background-image:url(<?php echo stcdnimg($relatedPosts->fields->img); ?>)"></i></div><h2><?php $relatedPosts->title(); ?></h2><!--<h4><span class="hunter-tag btn btn-default"><?php $relatedPosts->category(',', false, 'none'); ?></span> <span class="hunter-product"><?php Postviews($relatedPosts); ?>阅读</span></h4>--></a></div></div>
	  <?php else: ?>
