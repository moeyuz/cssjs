...
<?php while($categoryPosts->next()): ?>
      <div class="item">
                ...
                <div class="item-thumb"><div class="feaimg"><a href="<?php $categoryPosts->permalink(); ?>" class="block-fea scrollLoading" data-url="<?php echo stcdnimg($categoryPosts->fields->img); ?>" ></a><div class="entyr-icon ico-p"><?php if ($categoryPosts->fields->videourl): ?><i class="icon iconfont icon-icon-test15"></i><?php else : ?><?php echo ''.imgNums($categoryPosts->content).'' ; ?><?php endif; ?></div></div></div>
                <div class="item-main">
